...
export interface S3Repository {
   ...
   * @param bucket Optional bucket name (must be in allowed buckets, or uses default)
   */
  upload(key: string, body: Buffer | string, contentType?: string, bucket?: string): Promise<void>;
